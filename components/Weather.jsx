...
import { Container, CurrentDay, City, BigText, BigIcon, Temp, Description, Week } from './Styles';
            ...
            <Container>
                ...
                <Week horizontal={true} showsHorizontalScrollIndicator={false}>
                    {daysByHour.map((day, index) => (
                        <Card key={index} icon={day.icon} name={day.name.substring(0, 3)} temp={day.temp} hour={day.hour} />
                    ))}
                </Week>
            </Container>
        )
